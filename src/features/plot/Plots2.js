...
console.log("M: [Try monkey trading] ")
...
while(pool.length > 10) {
  step = Math.round((Math.random()/2) * 10)
  selectedValues.push(pool[step])
  pool = pool.slice(3,pool.length)
}
selectedValues = selectedValues.map((e,i) => i%2 == 0 ? -e : e)

console.log("M: [Randomly selected indices] pool ", selectedValues)

let lossess = []
let gains = []
console.log("M: [Randomly selected indices] ...", selectedValues.reduce((sum,cur) => {
  console.log("\n")
  console.log("M: [Randomly selected indices] cur: ", cur)
  if(sum < 0){
    lossess.push(sum)
  }else{
    gains.push(sum)
  }
  console.log("M: [Randomly selected indices] sum: ", sum)
  let out = cur + sum
  console.log("M: [Randomly selected indices] out: ", out)
  console.log("\n")
  return out
},0))
console.log("M: [Randomly selected indices] lossess total: ", lossess.reduce((sum,cur) => sum + cur,0))
console.log("M: [Randomly selected indices] lossess average: ", lossess.reduce((sum,cur) => sum + cur,0)/lossess.length)
console.log("M: [Randomly selected indices] lossess mean: ", lossess[Math.round(lossess.length/2)])
console.log("M: [Randomly selected indices] gains total: ", gains.reduce((sum,cur) => sum + cur,0))
console.log("M: [Randomly selected indices] gains average: ", gains.reduce((sum,cur) => sum + cur,0)/gains.length)
